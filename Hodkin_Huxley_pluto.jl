...
begin
	...
	start: $(@bind start NumberField(0:1:100, 20))\
	finish: $(@bind finish NumberField(0:1:100, 30))\
	"""
end

# ╔═╡ 69f55eb6-32c1-4400-8c01-11d2c1d5f96b
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "0c2da5aab6dd2a450404a3d0a248233ae11fd568"

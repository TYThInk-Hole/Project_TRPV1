...
# ╔═╡ 46ac6348-2a41-11ef-265e-7f5760191c26
using SymbolicRegression, MLJ, Plots, XLSX, DataFrames, PlutoUI

# ╔═╡ ee5ff599-a675-4887-ab03-c67d7a5527f6
begin
	md"""
	...
	a1: $(@bind a1 NumberField(0:0.1:200, 2.5))\
	a2: $(@bind a2 NumberField(0:0.1:100, 0.1))\
	a3: $(@bind a3 NumberField(0:0.1:100, 4))\
	a4: $(@bind a4 NumberField(0:0.1:100, 18))\
	
	"""
end

# ╔═╡ 18c41b4c-ff50-4a93-9d18-00ab645752e0
gNa, eNa, gK, eK, gL, eL = 120.0, 115.0, 36.0, -12.0, 0.3, 10.2

# ╔═╡ e588f8ac-ee33-4505-87ca-6ed0309a2b5a
begin
	tspan = (0,100)
	dt = 0.001
	u0 = [0.0, 0.0, 0.0]
...
# ╔═╡ a9938669-681c-4c69-a2b8-b4db85339781
...
# ╔═╡ 8f9ccc7b-4cd2-4452-870f-66265286f110
HH_model("Na_K")

# ╔═╡ c8bfffa8-59c7-4bac-8350-e6362e385d40
begin
	struct MySlider 
	    range::AbstractRange
	    default::Number
...
manifest_format = "2.0"
project_hash = "6700fad93dbf0a4849079fbbbe5a12a0f7521406"
